...
$(OBJDIR_DEBUG)/plugins/GetBlobStats.o: plugins/GetBlobStats.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c plugins/GetBlobStats.cpp -o $(OBJDIR_DEBUG)/plugins/GetBlobStats.o
...
$(OBJDIR_DEBUG)/dialogs/DialogStats.o: dialogs/DialogStats.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c dialogs/DialogStats.cpp -o $(OBJDIR_DEBUG)/dialogs/DialogStats.o
...
$(OBJDIR_RELEASE)/plugins/GetBlobStats.o: plugins/GetBlobStats.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c plugins/GetBlobStats.cpp -o $(OBJDIR_RELEASE)/plugins/GetBlobStats.o
